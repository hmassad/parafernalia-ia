...
public class RecibirOrdenCompraCCMessageDrivenBean implements MessageListener {
	...
	public void onMessage(Message message) {
		try {
			...
			for (OrCompCC.ItemOrdenCompraCC item : orCompCC.getItemsOCCC()) {
				...
				pedidoCasaCentralItemVO.setCodigo(item.getRodamiento().getCodigoRodamiento());
				pedidoCasaCentralVO.getItems().add(pedidoCasaCentralItemVO);
			}

			fachadaSessionBeanRemote.recibirPedidoCasaCentral(pedidoCasaCentralVO);
