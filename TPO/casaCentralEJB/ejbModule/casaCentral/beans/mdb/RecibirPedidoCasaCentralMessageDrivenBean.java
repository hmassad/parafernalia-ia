...
/**
 * Message-Driven Bean implementation class for: RecibirPedidoCasaCentralMessageDrivenBean
 *
 */
@MessageDriven(activationConfig = {
		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
		@ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/ordenCompraAcepQueue") })
public class RecibirPedidoCasaCentralMessageDrivenBean implements MessageListener {
