...
public class SolMatPriTest {
	...
	public static void main(String[] args) {
		...
		solMatPri1.getItems().add(new Item(1, "codigo1", 1));
		solMatPri1.getItems().add(new Item(2, "codigo2", 2));
		solMatPri1.getItems().add(new Item(3, "codigo3", 3));
		solMatPri1.getItems().add(new Item(4, "codigo4", 4));
		solMatPri1.getItems().add(new Item(5, "codigo5", 5));
