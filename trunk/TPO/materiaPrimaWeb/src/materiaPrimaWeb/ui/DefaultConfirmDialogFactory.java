...
import materiaPrimaWeb.ui.ConfirmDialog.Factory;
...
//		scroll.setScrollable(true);
		...
		Label text = new Label("", ContentMode.TEXT);
	 ...
	 * @return
	 */
	protected double[] getDialogDimensions(String message, ContentMode style) {
